...
output_filename="$home_directory/Results/T2starMoCo/logs/log_${timestamp}.txt"
...
nohup python -u ./core/Main.py --config_path ./projects/moco_t2star/configs/config_test_"$host_id".yaml > "$output_filename" &
